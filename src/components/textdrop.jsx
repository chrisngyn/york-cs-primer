...
export default function TextDrop(props) {
  ...
  return (
    <div style={style} className={`h-24 w-90% lg:w-70% bg-owbord relative dark:shadow-botdark select-none overflow-clip dark:bg-darkbord font-poppins mt-5 ease-in-out rounded-lg transition-all`}>
      ...
      <div ref={ref} className={`${effect ? "visible" : "invisible"} pl-5 pr-5 pb-3 text-sm xl:text-lg whitespace-pre-line dark:text-white`}>
